    ...
    actions
    {
        area(Processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(TestCreatePaymentRequest)
                {
                    ApplicationArea = All;
                    Caption = 'Test Create Payment Request';
                    Image = TestFile;
                    Promoted = true;
                    PromotedCategory = Process;
                    ...
                    begin
                        ...
                        ResponseText := ESSManagement.CreateorEditPaymentRequest('', '2026-05-18', 'TRIBASE', '102001', 3, 'B-00003', '', 'Payment for logistics', '', 250000, 'LAGOS', 'ENGR', false, 1, '', PaymentReqLines);
