// table 50563 "Posted Store Requisition"
// {
...
//         field(14; "Actual User 2"; Text[250])
//         {
...
//     // begin
//     //     WITH StoreRec DO BEGIN
//     //         StoreRec := Rec;
//     //         CustomSetup.GET;
//     //         CustomSetup.TESTFIELD("Store Requisition Nos.");
//     //         IF NoSeriesMgt.SelectSeries(CustomSetup."Store Requisition Nos.", OldStore."No. Series", "No. Series") THEN BEGIN
//     //             CustomSetup.GET;
//     //             CustomSetup.TESTFIELD("Store Requisition Nos.");
...
//     begin
//         CustSetup.GET;
//         CustSetup.TestField("Purchase Requisition Nos.");
//         IF "PRQ Created" THEN
...
//             PurchReqNo2 := NoSeriesMgt.GetNextNo(CustSetup."Purchase Requisition Nos.", TODAY, TRUE);
